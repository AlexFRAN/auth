...
/**
 * Interface for session-handling interfaces, these could be session-handlers, but also token-handlers (for instance apps do not use sessions for their server requests, but either use a token or something like jwt)
 */
